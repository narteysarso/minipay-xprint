(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("electron-serve"), require("electron-store"), require("pdf-to-printer"), require("node-fetch"));
	else if(typeof define === 'function' && define.amd)
		define(["electron-serve", "electron-store", "pdf-to-printer", "node-fetch"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("electron-serve"), require("electron-store"), require("pdf-to-printer"), require("node-fetch")) : factory(root["electron-serve"], root["electron-store"], root["pdf-to-printer"], root["node-fetch"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(global, (__WEBPACK_EXTERNAL_MODULE_electron_serve__, __WEBPACK_EXTERNAL_MODULE_electron_store__, __WEBPACK_EXTERNAL_MODULE_pdf_to_printer__, __WEBPACK_EXTERNAL_MODULE_node_fetch__) => {
...
/* harmony import */ var _printer__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./printer */ "./main/helpers/printer.js");
...
function createWindow(windowName, options) {
  ...
  electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on('get_printers', async event => {
    const printers = await (0,_printer__WEBPACK_IMPORTED_MODULE_13__.getPrinters)();
    event.sender.send('printers_list', {
      printers
    });
  });
  electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on('print_doc', async (event, printInfo = {
    url,
    options: {}
  }) => {
    ...
    try {
      ...
      await (0,_printer__WEBPACK_IMPORTED_MODULE_13__.print)(printInfo['url'], printInfo['options']);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getDefaultPrinter: () => (/* binding */ getDefaultPrinter),
/* harmony export */   getPrinters: () => (/* binding */ getPrinters),
...
const ptp = __webpack_require__(/*! pdf-to-printer */ "pdf-to-printer");
...
const print = async (url, options) => {
  try {
    ...
    await new (_babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_9___default())((resolve, reject) => {
    ...
    await ptp.print(tmpFilePath, _objectSpread(_objectSpread({}, defaultOptions), options));
    fs.unlinkSync(tmpFilePath);
  } catch (error) {
    console.log(error);
  }
};
const getPrinters = async () => await ptp.getPrinters();
const getDefaultPrinter = async () => await ptp.getDefaultPrinter();
...
"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE_pdf_to_printer__;
